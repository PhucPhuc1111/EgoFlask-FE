        ...
        <div className="p-6 md:p-12 flex flex-col md:flex-row md:space-x-16 space-y-6 md:space-y-0">
          ...
          <div className='w-full'>
            <div className="flex flex-col justify-center items-center h-auto">
              <div className="space-y-4 pt-6 md:pt-12 flex flex-col items-center justify-center">
                <div className="">
                  <IoCheckmarkCircle className="text-white w-16 md:w-32" />
                </div>
                <p className="text-white text-xl md:text-3xl font-semibold">Thanh toán thành công</p>
                <Link to={'/orders'} className="text-white hover:text-white text-sm md:text-base">
                  Xem đơn hàng
                </Link>
              </div>
            </div>
