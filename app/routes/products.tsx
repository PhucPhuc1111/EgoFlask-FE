        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          {_.map(productList, (product, index) => (
            ...
            >
              ...
              <div className="flex justify-center">
                <button onClick={() => navigate(`/products/${product.productId}`)} className="w-full mt-4 py-2 bg-white text-sm sm:text-base lg:text-lg text-black rounded hover:bg-slate-300">
                  Chi tiết sản phẩm
                </button>
              </div>
            </div>
