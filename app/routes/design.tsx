...
export default function Design() {
  ...
  const handleEngravePositionChange = (
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col lg:flex-row w-full items-center justify-center gap-6 lg:gap-14 lg:mt-auto mt-6  ">
          <div className="border-[3px] border-[#0055C3] rounded-xl w-full max-w-md lg:max-w-xl flex flex-col items-center justify-center gap-4 py-6 px-4 sm:px-10">
            <img
              src="/images/BigLogo.png?v=1"
              alt="Logo"
              className="aspect-[157/45] w-[120px] h-[40px] sm:w-[157px] sm:h-[45px]"
            />
            <div className="self-start cursor-pointer flex flex-col gap-3 w-full ">
              {_.map(options, (option, index) => (
                <div key={index} className="flex flex-col w-full">
                  ...
                  {active === option.value && (
                    <div className="grid grid-cols-6 sm:grid-cols-8 mt-2 gap-2 ">
                      {_.map(componentList, (component, idx) => (
                        <div
                          key={idx}
                          className={`w-6 h-6 sm:w-8 sm:h-8 cursor-pointer rounded-full ${
                            (option.value === "top" &&
                              top?.color === component.color) ||
                            (option.value === "body" &&
                              body?.color === component.color) ||
                            (option.value === "strap" &&
                              strap?.color === component.color)
                              ? "border-2 border-black ring-2 p-3"
                              : ""
                          }`}
                          style={{ backgroundColor: component.color }}
                          onClick={() =>
                            handleColorSelect(option.value, component)
                          }
                        />
                      ))}
                    </div>
              ...
              <div className="w-full border-b-2 border-[#E6E6E0] pb-4">
                <div className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="ml-auto text-xs sm:text-sm text-black">
                    Miễn phí
                  </span>
                </div>
              </div>
              ...
              <div className="py-2">
                <label className="text-xs sm:text-sm text-black">
                  Nhập nội dung (tối đa 8 ký tự):
                </label>
                <input
                  type="text"
                  className="w-full mt-1 border border-[#E6E6E0] p-2 text-xs sm:text-sm"
                  maxLength={8}
                  value={engrave}
                  onChange={handleEngraveChange}
                />
          ...
          <div className="flex flex-col w-full items-center justify-center mt-12">
            <h4 className="text-[18px] sm:text-[20px] leading-5 text-black font-bold mt-4 lg:mt-10">
              Thiết kế chiếc bình giữ nhiệt của riêng bạn
            </h4>
            <div uk-slider="sets: true; finite: true;">
              <div className="uk-inline">
                    ...
                    {_.map(componentList, (component, index) => (
                      ...
                      >
                        <img
                          ...
                          alt={component.name}
                          className="object-cover h-[300px] sm:h-[400px] md:h-[500px] "
                        />
                      </div>
                    ))}
                  </div>
                ...
                <a
                  ...
                  uk-slider-item="previous"
                >
                  <IoArrowBackCircle className="w-8 h-10 sm:h-14 text-[#0055C3] cursor-pointer" />
                </a>
                <a
                  ...
                  uk-slider-item="next"
                >
                  <IoArrowForwardCircle className="w-8 h-10 sm:h-14 text-[#0055C3] cursor-pointer" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-end mt-6 lg:mt-8 gap-4 lg:gap-10">
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition text-sm sm:text-sm"
            onClick={handleReview}
          >
            Review sản phẩm
          </button>
