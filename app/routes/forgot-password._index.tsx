  ...
  return (
    <main className="lg:mt-[--m-header-top] xl:px-[500px] pb-[--m-footer-bottom]">
      <div className="w-full flex flex-col items-center justify-center gap-9 pt-12 lg:pt-20 mx-auto">
        <p className="text-center text-[#393334] text-sm md:text-base mt-20">
          Đặt lại mật khẩu
        </p>
        <form
          onSubmit={handleSubmit(onSubmit)}
        ...
        >
          ...
          />
          {errors.email && <span className="text-red-500 font-bold text-xs md:text-sm">{errors.email.message}</span>}
