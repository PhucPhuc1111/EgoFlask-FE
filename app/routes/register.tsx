  ...
  return (
    ...
    <div className="w-full flex flex-col items-center justify-center gap-2 pt-5 mx-auto">
        ...
        <form
          ...
          <button type="submit" disabled={isSubmitting} className="flex items-center justify-center uppercase active:bg-blue-800 hover:bg-blue-900 disabled:bg-blue-900 bg-[#0055C3] w-full py-4 rounded-lg text-white font-semibold text-lg sm:text-xl">
            {isSubmitting && <img src="/icons/loading.svg" alt="" className="w-10 h-10" />}
            <span>
              Tạo tài khoản
            </span>
