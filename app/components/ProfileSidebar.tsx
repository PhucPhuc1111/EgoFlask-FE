      ...
      <div className="my-7 space-y-4 lg:space-y-8">
        {_.map(links, (link, index) => (
          <NavLink
            ...
            to={link.to}
            className={({ isActive }) =>
              `block font-semibold font-['Noto Serif'] p-3 lg:p-4 border-2 rounded-r-3xl w-full ${isActive ? 'bg-[#0055C3] text-white border-[#0055C3] hover:text-white hover:no-underline'
