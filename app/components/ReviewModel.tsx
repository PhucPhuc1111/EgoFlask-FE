...
export const ReviewModal: React.FC<ReviewModalProps> = ({ top, body, strap, onClose, isOpen }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-lg p-6 min-h-[650px] min-w-[500px] relative">
        ...
        <Model topImage={top?.imageUrl} bodyImage={body?.imageUrl} strapImage={strap?.imageUrl} width="500px" />
