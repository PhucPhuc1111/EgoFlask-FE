...
export default function Login() {
  return (
    <main className="lg:mt-[--m-header-top] xl:px-[500px]">
      <div className="w-full flex flex-col items-center justify-center gap-9 pt-52 mx-auto">
        ...
        <Form
          ...
          <input type="text" placeholder="Email" className="w-full focus:ring-0 border-0 border-b-2 border-[#E6E6E0] rounded-md" />
          <input type="password" placeholder="Mật khẩu" className="w-full focus:ring-0 border-0 border-b-2 border-[#E6E6E0] rounded-md" />
